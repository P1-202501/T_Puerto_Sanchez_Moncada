...
# 7. Crear columna IMC = Peso / (Talla/100)^2
df['IMC'] = df['Peso'] / (df['Talla']/100)**2
print("\nColumna IMC creada:")
print(df[['Peso', 'Talla', 'IMC']].head())

# 8. Crear clasificación de IMC
